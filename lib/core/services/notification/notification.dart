...
enum NotificationMode { warning, error, message }

class AppNotification {
  AppNotification._();

  static showSnackBar({NotificationMode notificationMode = NotificationMode.message, Duration duration = const Duration(milliseconds: 700), required String message}) {
